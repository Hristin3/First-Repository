...
<?php session_start();
    if(isset($_POST['reset'])) {
        session_destroy();
        header('Location: http://localhost:63342/PHP-Forms-Homework/comboBox.php');
    }
?>
<html>
<head>
    ...
    <script>
        function getContinent() {
            ...
            window.location.href = 'http://localhost:63342/PHP-Forms-Homework/comboBox.php?continent=' + continent;
